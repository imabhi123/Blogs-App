  ...
  return (
    <div>
      <nav className="navbar navbar-expand-lg navbar-light bg-light m-auto px-md-3 pt-3">
        <h1 className="navbar-brand px-3 text-success fs-1  fw-bold" to="/">
          CrossVal.
        </h1>
        <button
          ...
          <ul className="navbar-nav mr-auto">
            <li className="nav-item fw-bold px-3  active">
              <Link className="nav-link " to="/">
                Home <span className="sr-only d-none">(current)</span>
              </Link>
            </li>
        ...
        <form className="form-inline my-2 px-3 my-lg-0">
          <button
            className="btn-success btn-outline-0 border-0 rounded text-white my-2 py-1 px-3 fw-bold "
            type="submit"
